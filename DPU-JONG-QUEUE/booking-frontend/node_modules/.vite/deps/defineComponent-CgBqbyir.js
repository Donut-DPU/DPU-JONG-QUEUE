import { Comment, Fragment, camelize, capitalize, computed, defineComponent, getCurrentInstance as getCurrentInstance$1, inject, isVNode, provide, reactive, ref, shallowRef, toRef, unref, warn, watchEffect } from "./vue.runtime.esm-bundler-D72dexdH.js";
...
//#endregion
export { CircularBuffer, DefaultsSymbol, EventProp, IN_BROWSER, PREFERS_REDUCED_MOTION, SUPPORTS_INTERSECTION, SUPPORTS_MATCH_MEDIA, SUPPORTS_TOUCH, callEvent, camelizeProps, checkPrintable, chunk, clamp, consoleError, consoleWarn, convertToUnit, createDefaults, createRange, debounce, defer, defineComponent$1 as defineComponent, defineFunctionalComponent, deprecate, destructComputed, ensureValidVNode, eventName, filterInputAttrs, findChildrenWithProvide, flattenFragments, focusChild, focusableChildren, genericComponent, getCurrentInstance, getCurrentInstanceName, getNextElement, getObjectValueByPath, getPropertyFromItem, has, hasEvent, humanReadableFileSize, includes, isClickInsideElement, isEmpty, isObject, isOn, isPrimitive, keyValues, keys, matchesSelector, mergeDeep, omit, onlyDefinedProps, padEnd, padStart, pick, propsFactory, provideDefaults, refElement, templateRef, toKebabCase, useDefaults, wrapInArray };
//# sourceMappingURL=defineComponent-CgBqbyir.js.map