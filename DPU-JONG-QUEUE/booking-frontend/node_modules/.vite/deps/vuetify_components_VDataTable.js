import { Fragment, capitalize, computed, createBaseVNode, createTextVNode, createVNode, inject, mergeProps, normalizeClass, normalizeStyle, provide, ref, shallowRef, toDisplayString, toRaw, toRef, toRefs, toValue, unref, watch, watchEffect, withModifiers } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { EventProp, callEvent, clamp, consoleError, convertToUnit, defineFunctionalComponent, genericComponent, getCurrentInstance, getObjectValueByPath, getPropertyFromItem, isEmpty, isOn, isPrimitive, omit, pick, propsFactory, provideDefaults, wrapInArray } from "./defineComponent-CgBqbyir.js";
import { useRender } from "./useRender-Cko3q1Tr.js";
import "./anchor-DBESzmxd.js";
import "./animation-DgqxdOAG.js";
import "./VOverlay-D4xUc5fo.js";
import "./colorUtils-z9p75JAN.js";
import "./createSimpleFunctional-BkMWtuQb.js";
import { deepEqual } from "./deepEqual-CGPeGav_.js";
import "./easing-Dv_s-_U7.js";
import "./lazy-Cr_cwhNC.js";
import "./VList-CQOSXBBg.js";
import "./dimensions-DgdRtmat.js";
import "./resizeObserver-CQMJ50_l.js";
import "./ssrBoot-GlcHNsDK.js";
...
import { useBackgroundColor } from "./color-BDEACbS4.js";
...
import { makeDensityProps } from "./density-wp4XFZ9C.js";
import "./variant-PSUlC7g9.js";
import "./VAvatar-dW7YhFK2.js";
import "./VProgressLinear-Cd-OjZOq.js";
import { LoaderSlot, makeLoaderProps, useLoader } from "./loader-CXfxZCQa.js";
import "./position-C8P492hT.js";
import "./router-DxZezryf.js";
import "./ripple-BkRwbklX.js";
import "./transitions-CXCUwNFE.js";
import { VBtn } from "./VBtn-Cl-ySuzd.js";
import "./group-DFRin0Su.js";
import "./VProgressCircular-BBaUYapN.js";
import "./VBtn-CDYi5gu1.js";
import { VDivider } from "./VDivider-C9s4T0RN.js";
import { makeDisplayProps, useDisplay } from "./display-CMlUeaXm.js";
import "./goto-DeAJwcmA.js";
import "./delay-DfsxHWbl.js";
import "./scopeId-Dlc1PBvq.js";
import "./VSlideGroup-BRQzr9Bp.js";
import "./VChipGroup-CQ8SVfiG.js";
import { VChip } from "./VChip-BqDQYoMx.js";
import "./VLabel-mY1EZYUZ.js";
import "./VSelectionControl-DOof780a.js";
import { VCheckboxBtn, VSelect, VVirtualScrollItem, makeVirtualProps, useVirtual } from "./VSelect-D1eDM7Pf.js";
import "./VInput-DJm4tukq.js";
import "./form-B21IvR-s.js";
import "./forwardRefs-CMej1yW5.js";
import "./VMenu-Cq9L39oe.js";
import "./VField-D7XogP1R.js";
import "./autofocus-Ca5LEP5_.js";
import "./VTextField-DKbnFuNB.js";
import { VTable, makeVTableProps } from "./VTable-uchLXEJY.js";
import { VPagination } from "./VPagination-CYzplStQ.js";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDataTable/VDataTable.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDataTable/VDataTableFooter.css";
	...
	setup(props, _ref) {
		...
		useRender(() => {
			...
			return createBaseVNode("div", { "class": "v-data-table-footer" }, [
				slots.prepend?.(),
				createBaseVNode("div", { "class": "v-data-table-footer__items-per-page" }, [createBaseVNode("span", { "aria-label": t(props.itemsPerPageText) }, [t(props.itemsPerPageText)]), createVNode(VSelect, {
...
const VDataTableHeaders = genericComponent()({
	...
	setup(props, _ref) {
		...
		function handleEnterKeyPress(event, column) {
			if (event.key === "Enter" && !props.disableSort) toggleSort(column);
		}
		function getSortIcon(column) {
			const item = sortBy.value.find((item$1) => item$1.key === column.key);
		...
		const VDataTableHeaderCell = (_ref2) => {
			...
			const isEmpty$1 = column.key === "data-table-group" && column.width === 0 && !column.title;
			...
			return createVNode(VDataTableColumn, mergeProps({
				...
				return createBaseVNode("div", { "class": "v-data-table-header__content" }, [
					...
					}, [sortBy.value.findIndex((x$1) => x$1.key === column.key) + 1])
				]);
			} });
		};
		const VDataTableMobileHeaderCell = () => {
			...
			}, { chip: (props$1) => createVNode(VChip, {
				"onClick": props$1.item.raw?.sortable ? () => toggleSort(props$1.item.raw) : void 0,
				"onMousedown": (e) => {
					e.preventDefault();
					e.stopPropagation();
				}
			}, { default: () => [props$1.item.title, createVNode(VIcon, {
				"class": normalizeClass(["v-data-table__td-sort-icon", isSorted(props$1.item.raw) && "v-data-table__td-sort-icon-active"]),
...
function provideExpanded(props) {
	...
	function expand(item, value) {
		...
		if (!value) {
			const item$1 = [...expanded.value].find((x) => toRaw(x) === rawValue);
		...
		useRender(() => {
			...
			return createBaseVNode(Fragment, null, [props.items.map((item, index) => {
				if (item.type === "group") {
					...
					return slots["group-header"] ? slots["group-header"](slotProps$1) : createVNode(VDataTableGroupHeaderRow, mergeProps({
		...
		useRender(() => {
			...
			return createVNode(VTable, mergeProps({
				...
				default: () => slots.default ? slots.default(slotProps.value) : createBaseVNode(Fragment, null, [
					...
					!props.hideDefaultHeader && createBaseVNode("thead", { "key": "thead" }, [createVNode(VDataTableHeaders, dataTableHeadersProps, slots)]),
