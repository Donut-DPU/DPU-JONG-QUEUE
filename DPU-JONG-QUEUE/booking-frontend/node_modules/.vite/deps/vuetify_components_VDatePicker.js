import { Fragment, computed, createBaseVNode, createTextVNode, createVNode, mergeProps, normalizeClass, normalizeStyle, ref, shallowRef, toRef, watch, watchEffect, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { EventProp, convertToUnit, createRange, genericComponent, omit, propsFactory, templateRef, wrapInArray } from "./defineComponent-CgBqbyir.js";
import { makeComponentProps, useRender } from "./useRender-Cko3q1Tr.js";
...
import { useLocale, useRtl } from "./locale-BQ_y70O8.js";
...
import { MaybeTransition } from "./transition-CLrhi9VH.js";
import { intersect_default } from "./intersect-BudTIVkh.js";
import { makeBorderProps, makeElevationProps, useBorder, useElevation } from "./elevation-ByLT6PoR.js";
...
import { VFadeTransition } from "./transitions-OU6a34m8.js";
import "./display-DbA0YUUq.js";
import { VSpacer } from "./VGrid-CEkX4uME.js";
import { createDateRange, daysDiff, useDate } from "./date-PtuMeX6k.js";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDatePicker/VDatePicker.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDatePicker/VDatePickerControls.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDatePicker/VDatePickerHeader.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonth.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonths.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VDatePicker/VDatePickerYears.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/labs/VPicker/VPicker.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VSheet/VSheet.css";
	...
	setup(props, _ref) {
		...
		useRender(() => {
			return createBaseVNode("div", {
				...
				createBaseVNode("div", { "class": "v-date-picker-controls__month" }, [createVNode(VBtn, {
...
function useCalendar(props) {
	...
	const weeksInMonth = computed(() => {
		...
		const daysInMonth$1 = 42;
		if (props.weeksInMonth === "static" && days.length < daysInMonth$1) {
			const lastDay = days[days.length - 1];
			let week = [];
			for (let day = 1; day <= daysInMonth$1 - days.length; day++) {
...
const VDatePickerYears = genericComponent()({
	...
	setup(props, _ref) {
		...
		useRender(() => withDirectives(createBaseVNode("div", {
			...
			"style": { height: convertToUnit(props.height) }
		}, [createBaseVNode("div", { "class": "v-date-picker-years__content" }, [years.value.map((year, i) => {
			const btnProps = {
