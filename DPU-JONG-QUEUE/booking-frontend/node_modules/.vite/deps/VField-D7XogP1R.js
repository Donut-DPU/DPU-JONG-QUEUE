import { Fragment, computed, createBaseVNode, createVNode, mergeProps, normalizeClass, normalizeStyle, ref, toRef, useId, vShow, watch, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { EventProp, PREFERS_REDUCED_MOTION, convertToUnit, genericComponent, propsFactory } from "./defineComponent-CgBqbyir.js";
import { makeComponentProps, useRender } from "./useRender-Cko3q1Tr.js";
import { animate, nullifyTransforms } from "./animation-DgqxdOAG.js";
...
import { VExpandXTransition, VSlideYTransition } from "./transitions-CXCUwNFE.js";
import { VLabel } from "./VLabel-mY1EZYUZ.js";
import { makeFocusProps, useFocus, useInputIcon } from "./VInput-DJm4tukq.js";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VCounter/VCounter.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VField/VField.css";
		...
		useRender(() => {
			...
			return createBaseVNode("div", mergeProps({
				...
				createBaseVNode("div", {
					...
					hasFloatingLabel.value && createBaseVNode("div", { "class": "v-field__outline__notch" }, [createVNode(VFieldLabel, {
						"ref": floatingLabelRef,
						"floating": true,
						"for": id.value,
						"aria-hidden": !isActive.value
...
//#endregion
export { VCounter, VField, makeVFieldProps };
//# sourceMappingURL=VField-D7XogP1R.js.map