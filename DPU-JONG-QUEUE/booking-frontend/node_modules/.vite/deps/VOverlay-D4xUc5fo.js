import { Fragment, Teleport, Transition, computed, createBaseVNode, createVNode, effectScope, inject, mergeProps, nextTick, onBeforeUnmount, onMounted, onScopeDispose, provide, reactive, readonly, ref, shallowRef, toRaw, toRef, toValue, vShow, warn, watch, watchEffect, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { CircularBuffer, IN_BROWSER, clamp, consoleError, convertToUnit, destructComputed, eventName, genericComponent, getCurrentInstance, isOn, matchesSelector, propsFactory, templateRef } from "./defineComponent-CgBqbyir.js";
import { makeComponentProps, useRender } from "./useRender-Cko3q1Tr.js";
import { flipAlign, flipCorner, flipSide, getAxis, parseAnchor } from "./anchor-DBESzmxd.js";
import { Box, animate, getElementBox, getOverflow, getTargetBox, nullifyTransforms } from "./animation-DgqxdOAG.js";
import { deepEqual } from "./deepEqual-CGPeGav_.js";
import { standardEasing } from "./easing-Dv_s-_U7.js";
import { getScrollParent, getScrollParents, hasScrollbar, makeLazyProps, useLazy } from "./lazy-Cr_cwhNC.js";
...
import { useRtl } from "./locale-BQ_y70O8.js";
import { makeThemeProps, provideTheme } from "./theme-Du9u69_b.js";
import { useBackgroundColor } from "./color-BDEACbS4.js";
import { MaybeTransition, makeTransitionProps } from "./transition-CLrhi9VH.js";
import { useBackButton, useRouter } from "./router-DxZezryf.js";
import { useDisplay } from "./display-CMlUeaXm.js";
import { makeDelayProps, useDelay } from "./delay-DfsxHWbl.js";
import { useScopeId } from "./scopeId-Dlc1PBvq.js";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VOverlay/VOverlay.css";
...
function connectedLocationStrategy(data, props, contentStyles) {
	...
	function updateLocation() {
		...
		function checkOverflow(_placement) {
			...
			let { x: x$1, y: y$1 } = getOffset(targetPoint, contentPoint);
...
const VOverlay = genericComponent()({
	...
	setup(props, _ref) {
		...
		}, contentEvents.value, props.contentProps), [slots.default?.({ isActive })]), [[vShow, isActive.value], [click_outside_default, {
...
//#endregion
export { VMenuSymbol, VOverlay, makeVOverlayProps };
//# sourceMappingURL=VOverlay-D4xUc5fo.js.map