import { Fragment, computed, createBaseVNode, createVNode, inject, mergeProps, nextTick, normalizeClass, normalizeStyle, onBeforeMount, onBeforeUnmount, provide, ref, shallowRef, toDisplayString, toRaw, toRef, toValue, vShow, watch, watchEffect, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { EventProp, consoleError, defineComponent, deprecate, focusChild, genericComponent, getCurrentInstance, getPropertyFromItem, isPrimitive, omit, pick, propsFactory, provideDefaults, wrapInArray } from "./defineComponent-CgBqbyir.js";
...
import { useProxiedModel } from "./proxiedModel-mFRMhcJ1.js";
import { makeThemeProps, provideTheme } from "./theme-CEGrhd9P.js";
import { makeDimensionProps, useDimension } from "./dimensions-DF7NkFFb.js";
import { useSsrBoot } from "./ssrBoot-fSwgtbhA.js";
import { makeTagProps } from "./tag-BcEB9qN8.js";
import { VExpandTransition } from "./transitions-MnUzB6uM.js";
import { VDefaultsProvider } from "./VDefaultsProvider-C_3x02tZ.js";
import { useBackgroundColor, useTextColor } from "./color-C11SR-We.js";
import { IconValue } from "./icons-BD2Uqo7x.js";
import { VIcon } from "./VIcon-Dm3BRCm0.js";
import { makeRoundedProps, useRounded } from "./rounded-BfUEHU_d.js";
import { MaybeTransition } from "./transition-DGfb6csH.js";
import { makeBorderProps, makeElevationProps, useBorder, useElevation } from "./elevation-CeNbRUZG.js";
import { makeDensityProps, useDensity } from "./density-BjUa1eby.js";
import { genOverlays, makeVariantProps, useVariant } from "./variant-DNSMlzlb.js";
import { VAvatar } from "./VAvatar-JOXZCl9z.js";
import { makeRouterProps, useLink } from "./router-Cs11BpWN.js";
import { ripple_default } from "./ripple-qFYA4udC.js";
import { VDivider } from "./VDivider-CBM4B_10.js";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VList/VList.css";
import "D:/NATTO/DPU-JONG-QUEUE/DPU-JONG-QUEUE/booking-frontend/node_modules/vuetify/lib/components/VList/VListItem.css";
...
const useNestedItem = (id, isDisabled, isGroup) => {
	...
	onBeforeMount(() => {
		if (!parent.isGroupActivator) nextTick(() => {
			parent.root.register(computedId.value, parent.id.value, toValue(isDisabled), isGroup);
		});
	});
	onBeforeUnmount(() => {
		if (!parent.isGroupActivator) parent.root.unregister(computedId.value);
	});
...
const VListItem = genericComponent()({
	...
	setup(props, _ref) {
		...
		const { activate, isActivated, select, isOpen, isSelected, isIndeterminate, isGroupActivator, root, parent, openOnSelect, id: uid } = useNestedItem(id, () => props.disabled, false);
		const list = useList();
...
//#endregion
export { VList, VListGroup, VListImg, VListItem, VListItemAction, VListItemMedia, VListItemSubtitle, VListItemTitle, VListSubheader, makeItemsProps, useItems };
//# sourceMappingURL=VList-CXkHuyjg.js.map